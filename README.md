...
|TS-06|Obtención de costos por id de usuario|Como desarrollador, quiero implementar la posibilidad de obtener costos por id de un usuario en específico a través de una API para que pueda estar disponible en la aplicación|<p>Background: Teniendo de endpoint “http://localhost:port/api/v1/users/{userId}/costs” disponible</p><p><br>Scenario 1: Usuario quiere visualizar sus costos<br><br>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de los costos<br>Entonces el response es brindado con status 200<br>Y se mostrarán los costos relacionados al usuario en específico</p><p><br>Scenario 2: Usuario quiere visualizar sus costos pero no existen</p><p>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de los costos<br>Entonces el response es brindado con status 200 pero no se mostrarán los costos</p>|EP01|
|TS–07|Obtención de cultivos por id de usuario|Como desarrollador, quiero obtener los cultivos de un usuario en específico a través de una API, para que los usuarios puedan interactuar con la aplicación de manera eficiente.|<p>Background: Teniendo de endpoint “http://localhost:{port}/api/v1/users/{userId}/crops” disponible<br><br>Escenario 1: Usuario quiere visualizar sus cultivos<br><br><br>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de los cultivos<br>Entonces el response es brindado con status 200<br>Y se mostrarán los cultivos relacionados al usuario en específico<br><br><br>Escenario 2: Usuario quiere visualizar sus cultivos pero no existen</p><p>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de los cultivos<br>Entonces el response es brindado con status 200 pero no se mostrarán los cultivos</p>|EP01|
|TS-08|Obtención de ordenes por id de usuario|Como desarrollador, quiero obtener la información de las órdenes de un usuario en específico mediante una API<br>Para que pueda estar disponible en la aplicación |<p>Background: Teniendo de endpoint “http://localhost:{port}/api/v1/users/{userId}/orders” disponible<br><br>Escenario 1: Usuario quiere visualizar sus ordenes <br><br><br>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de las órdenes<br>Entonces el response es brindado con status 200<br>Y se mostrarán las órdenes relacionados al usuario en específico<br><br>Escenario 2: Usuario quiere visualizar sus órdenes pero no existen</p><p>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de órdenes<br>Entonces el response es brindado con status 200 pero no se mostrarán las órdenes dado que no existen</p>|EP01|
|TS-09|Obtención de ganancias por id de usuario|<p>Como desarrollador, quiero obtener las ganancias agrícolas de un usuario en específico a través de una API. Para que pueda estar disponible en la aplicación </p><p></p><p></p>|<p>Background: Teniendo de endpoint “http://localhost:{port}/api/v1/users/{userId}/profits” disponible<br><br>Escenario 1: Usuario quiere visualizar sus ganancias<br><br>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de las ganancias<br>Entonces el response es brindado con status 200<br>Y se mostrarán las ganancias relacionados al usuario en específico</p><p></p><p><br>Escenario 2: Usuario quiere visualizar sus órdenes pero no existen<br><br>Dado que un usuario ha ingresado sus credenciales y se creó de manera automática un id correctamente<br>Cuando realiza una solicitud de obtención de ganancias<br>Entonces el response es brindado con status 200 pero no se mostrarán las ganancias  dado que no existen</p><p></p>|EP01|
|TS-10|Seguridad y encriptación de contraseñas en el inicio de sesión|Como desarrollador, quiero que la contraseña que brinde el usuario al momento de registrarse sea encriptada<br>Para que exista un estándar de seguridad y que la aplicación no sea vulnerable a ataques|<p>Escenario 1:<br>Creación de usuario exitosa</p><p>Dado que un usuario se encuentra en el endpoint “http://localhost:{port}/api/v1/users/sign-up”<br>Cuando ingrese datos en “username”, “email” y “password”<br>Entonces se mostrará el response con código 200 con un mensaje de “Registration successfully”<br>Y su contraseña se guarda en la base de datos encriptada</p><p>Escenario 2:<br>Inicio de sesión exitoso</p><p>Dado que un usuario se encuentra en el endpoint “http://localhost:{port}/api/v1/users/sign-in”<br>Cuando ingrese datos validos y existentes en “username”, “email” y “password”<br>Entonces se mostrará el response con código 200 con un mensaje de “Inicio de sesión exitoso”</p>|EP01|
...
| :-: | :-: | :-: | :-: | :-: |
|01|HU-13|Visualización de características de la aplicación web|Como usuario deseo ver las principales características de la aplicación para decidir si usar el producto en mi trabajo|5|
|02|HU-14|Landing Page responsive|Como usuario deseo visitar la landing page desde cualquier dispositivo|8|
|03|HU-15|Botón Call to Action|Como usuario deseo ir a la aplicación web desde un solo botón|5|
|04|HU-16|Visualización de botones y texto amplia y notoria|Como usuario deseo ver los botones y la información de las secciones o pantalla para una mejor navegación|3|
...
|13|HU-12|Atender pedidos|Como usuario deseo ver los pedidos que tengo de manera rápida y fácil en una pantalla|8|
|14|HU10|Gestión de Insumos Agrícolas|Como agricultor, quiero llevar un registro de los insumos agrícolas utilizados para analizarlo y tomar decisiones de acuerdo con ello|3|
...
|24|TS-06|Obtención de costos por id de usuario|Como desarrollador, quiero implementar la posibilidad de obtener costos por id de un usuario en específico a través de una API para que pueda estar disponible en la aplicación|**3**|
|25|TS–07|Obtención de cultivos por id de usuario|Como desarrollador, quiero obtener los cultivos de un usuario en específico a través de una API, para que los usuarios puedan interactuar con la aplicación de manera eficiente.|**5**|
|26|TS-08|Obtención de ordenes por id de usuario|Como desarrollador, quiero obtener la información de las órdenes de un usuario en específico mediante una API<br>Para que pueda estar disponible en la aplicación |**5**|
|27|TS-09|Obtención de ganancias por id de usuario|<p>Como desarrollador, quiero obtener las ganancias agrícolas de un usuario en específico a través de una API. Para que pueda estar disponible en la aplicación </p><p></p><p></p>|**3**|
|28|TS-10|Seguridad y encriptación de contraseñas en el inicio de sesión|Como desarrollador, quiero que la contraseña que brinde el usuario al momento de registrarse sea encriptada<br>Para que exista un estándar de seguridad y que la aplicación no sea vulnerable a ataques|**3**|
...
![image](https://github.com/upc-2023-GreatMinds-SW51-Web/Informe-Final-Web/assets/104078975/f5689be5-7634-485e-b7b6-486a83ca993b)
